...
const canvas = document.querySelector("#slide_2 .fire canvas"),
...
const resize = () => {
  ...
  w = canvas.width = window.innerWidth; // Divide the width by the scale variable, then bitwise floor
  h = canvas.height = 500; // Divide the height by the scale variable, then bitwise floor
